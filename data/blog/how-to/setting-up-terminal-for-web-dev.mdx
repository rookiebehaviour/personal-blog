...
draft: false
summary: Little guide to getting your pc terminal set up for web development - recommended plugins, themes, fonts, etc.
---
...
Think of [Homebrew](https://docs.brew.sh/) as a package manager for macOS. It is a command line tool that allows you to install software on your pc. It is very easy to use and it is a must-have for any developer. You can install it by running the following command in your terminal:
